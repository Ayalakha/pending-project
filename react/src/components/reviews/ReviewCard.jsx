    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-all duration-300 shadow-sm">
              ...
              <div className="absolute right-0 mt-1 w-32 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                {isOwner && (
                  <button
                    ...
                    className="w-full px-3 py-2 text-left text-gray-700 hover:bg-gray-50 flex items-center space-x-2 text-sm"
                  >
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-left text-red-600 hover:bg-gray-50 flex items-center space-x-2 text-sm"
                >
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-200">
        <button
          ...
          className={`flex items-center space-x-2 text-sm  bg-white transition-colors ${
            review.is_helpful_to_user
              ? 'text-blue-600'
